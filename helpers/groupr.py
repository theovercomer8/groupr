...
def process(cfg:Config):
    ...
    dataset = TensorLoadingDataset(paths, config.cache_path, config.clip_preprocess,config.device,config.clip_model, config.debug, config.log_path, config.precision)
